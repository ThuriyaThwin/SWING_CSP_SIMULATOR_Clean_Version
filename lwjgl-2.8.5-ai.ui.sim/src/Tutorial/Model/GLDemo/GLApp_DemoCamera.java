...
import Tutorial.Model.App.GLCam;
import Tutorial.Model.App.GLCamera;
import Tutorial.Model.App.GLShadowOnPlane;
import Tutorial.Model.GLModel.GLModel;
import Tutorial.Model.GLModel.GL_Matrix;
import Tutorial.Model.GLModel.GL_Vector;
...
public class GLApp_DemoCamera extends GLApp {
	...
	public void setup() {
		...
		setLight(GL11.GL_LIGHT1, new float[] { 1f, 1f, 1f, 1f }, new float[] { 0.5f, 0.5f, .53f, 1f }, new float[] { 1f, 1f, 1f, 1f }, lightPosition);

		// Create a directional light (light green, to simulate reflection off grass)
		setLight(GL11.GL_LIGHT2, new float[] { 0.15f, 0.4f, 0.1f, 1.0f }, // diffuse color
